...
def check_linear_col():
    ...
    check_equal(out, C)
    logger.info("linear_col forward: pass")
    ...
    logger.info("linear_col backward: pass")
...
def check_linear_row():
    ...
    check_equal(out, C)
    logger.info("linear_row forward: pass")
    ...
    logger.info("linear_row backward: pass")
...
def check_classifier_no_given_weight():
    ...
    layer_master = ClassifierSTD(HIDDEN_SIZE, NUM_CLASSES, bias=True)
...
def check_classifier_given_embed_weight():
    ...
    layer_master = ClassifierSTD(HIDDEN_SIZE, NUM_CLASSES, weight=embed_master.weight, bias=False)
    layer_master = layer_master.to(dtype).to(device)
...
def check_vocab_parallel_loss():
    ...
    logger.info("vocab parallel loss forward: pass")
    ...
    logger.info("vocab parallel loss backward: pass")
